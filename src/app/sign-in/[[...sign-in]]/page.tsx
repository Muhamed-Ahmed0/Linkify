      ...
      <div className="w-full  lg:w-1/2 flex flex-col gap-4">
        ...
        <SignIn.Root>
          ...
          <div className="w-72 flex items-center gap-4">
            ...
            <span className="h-px text-textGrayLight mb-5">Or</span>
            <div className="h-px bg-borderGray flex-grow"></div>
          </div>
          <Link
            href="/sign-up"
            className="bg-iconBlue rounded-full text-white p-2 font-semibold w-72 text-center"
          >
            Create Account
          </Link>
